...
scpEx00120zzz0 :: Bytes
scpEx00120zzz0 = build $
...
scpEx00120zzz0FirstTextboxBS :: Bytes
scpEx00120zzz0FirstTextboxBS = build $
       w8 0x05 <> w8 0x10 <> w32LE 0x11
    <> utf8cstr str00120zzz0FirstTextbox
    <> utf8cstr "rei_K1_00001"
    <> w32LE 0x00

scpEx00120zzz0FirstTextboxAltOptsBS :: Bytes
scpEx00120zzz0FirstTextboxAltOptsBS = build $
